...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default panel-shadow" data-collapsed="0">
            ...
            <div class="panel-body">
				<?php echo form_open(base_url() . 'index.php?teacher/invoice/take_payment/'.$row['invoice_id'], array(
		            ...
		            <div class="form-group">
                        <label class="col-sm-3 control-label"><?php echo ('Moyen de Paiement');?></label>
                        <div class="col-sm-6">
