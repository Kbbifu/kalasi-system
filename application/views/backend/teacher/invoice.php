<div class="row">
	<div class="col-md-12">
		...
		<div class="tab-content">
            ...
            <?php echo form_open(base_url() . 'index.php?teacher/invoice/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel panel-default panel-shadow" data-collapsed="0">
                            <div class="panel-heading">
                                <div class="panel-title"><?php echo ('Informations recu');?></div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default panel-shadow" data-collapsed="0">
                            <div class="panel-heading">
                                <div class="panel-title"><?php echo ('Information Payment');?></div>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="amount"
                                            placeholder="<?php echo ('Entrer montant Total');?>"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="amount_paid"
                                            placeholder="<?php echo ('Entrer montant payé');?>"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="status" class="form-control">
                                            <option value="paid"><?php echo ('Payé');?></option>
                                            <option value="unpaid"><?php echo ('Non payé');?></option>
                                            <option value="incomplete"><?php echo ('Incomplete');?></option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="method" class="form-control">
                                            ...
                                            <option value="2"><?php echo ('Banque');?></option>
                                            <option value="3"><?php echo ('Carte');?></option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-5">
                                <button type="submit" class="btn btn-info"><?php echo ('Ajouter recu');?></button>
                            </div>
                        </div>
                    </div>
                </div>
