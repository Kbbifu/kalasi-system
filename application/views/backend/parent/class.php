                ...
                <table class="table table-bordered table-hover table-striped datatable" id="table_export">
                	<thead>
                		<tr>
                    		...
                    		<th><div><?php echo ('Titulaire');?></div></th>
                ...
                <div class="box-content">
                	<?php echo form_open('teacher/classes/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        <div class="padded">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('ID');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="name_numeric"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('Enseignant');?></label>
                                <div class="col-sm-5">
                        ...
                        <div class="form-group">
                              <div class="col-sm-offset-3 col-sm-5">
                                  <button type="submit" class="btn btn-info"><?php echo ('Ajouter Classe');?></button>
                              </div>
							</div>
                    </form>                
                </div>                
