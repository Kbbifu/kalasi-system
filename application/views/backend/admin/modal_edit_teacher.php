                    ...
                    <?php echo form_open(base_url() . 'index.php?admin/teacher/do_update/'.$row['teacher_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                        <div class="padded">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="validate[required]" name="titre" value="<?php echo $row['name'];?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('Fonction');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="validate[required]" name="fonction" value="<?php echo $row['name'];?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-gray"><?php echo ('Sauvegarder');?></button>
                        </div>
                    </form>
                    <?php endforeach;?>
                </div>
