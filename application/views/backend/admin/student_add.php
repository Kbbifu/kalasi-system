						...
						<label for="field-2" class="col-sm-3 control-label"><?php echo ('Section');?></label>
		                    <div class="col-sm-5">
		                        <select name="section_id" class="form-control" id="section_selector_holder"
									data-message-required="<?php echo ('Value Required');?>"
										onchange="return get('section_id')">
		                          <option value=""><?php echo ('Selectionner section');?></option>
			                      <?php 
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select name="statut" class="form-control">
                              <option value=""><?php echo ('Selectionner');?></option>
                              <option value="Actif"><?php echo ('Actif');?></option>
                              <option value="Inactif"><?php echo ('Inactif');?></option>
                          </select>
						</div> 
					</div>
