<hr />
	<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover table-striped">
    	<thead>
        	<tr>
            	<th><?php echo ('Selectionner Date');?></th>
            	<th><?php echo ('Selectionner Mois');?></th>
            	<th><?php echo ('Selectionner Année');?></th>
            	<th><?php echo ('Selectionner Classe');?></th>
            	<th><?php echo ('Selectionner Date');?></th>
           </tr>
       </thead>
		<tbody>
        	<form method="post" action="<?php echo base_url();?>index.php?admin/attendance_selector" class="form">
            	<tr class="gradeA">
                    ...
                    <td align="center"><input type="submit" value="<?php echo ('Gerer Présence');?>" class="btn btn-info"/></td>
                </tr>
            </form>
		</tbody>
	</table>
