            ...
            <div class="panel panel-primary" >
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group">
                      <label  class="col-sm-3 control-label"><?php echo ('System Nom');?></label>
                      <div class="col-sm-9">
                  ...
                  <div class="form-group">
                      <label  class="col-sm-3 control-label"><?php echo ('System Titre');?></label>
                      <div class="col-sm-9">
                  ...
                  <div class="form-group">
                      <label  class="col-sm-3 control-label"><?php echo ('Monnaie');?></label>
                      <div class="col-sm-9">
                  ...
                  <div class="form-group">
                      <label  class="col-sm-3 control-label"><?php echo ('Langue');?></label>
                      <div class="col-sm-9">
            ...
            <div class="panel panel-primary" >
                ...
                <center>
                  <div class="label label-primary" style="font-size: 12px;">
                    <i class="entypo-check"></i> <?php echo ('Choisir un theme pour changer');?>
                  </div>
                </center>
                </div>
