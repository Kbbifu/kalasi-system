		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/expense/edit/' . $row['payment_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label"><?php echo ('Numero Piece Justificatif');?></label>
                        
						<div class="col-sm-6">
							<input type="text" class="form-control" name="num_piece" data-validate="required" data-message-required="<?php echo ('Value Required');?>" 
							value="<?php echo $row['num_piece'];?>" >
						</div>
					</div>

					<div class="form-group">
                        <label class="col-sm-3 control-label"><?php echo ('Categorie');?></label>
                        <div class="col-sm-6">
                            <select name="expense_category_id" class="form-control" required>
                                <option value=""><?php echo ('Selectionner Categorie');?></option>
                                <?php 
					...
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo ('Montant');?></label>
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select name="method" class="form-control">
                                ...
                                <option value="3" <?php if ($row['method'] == 3) echo 'selected';?>><?php echo ('Carte');?></option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<button type="submit" class="btn btn-info"><?php echo ('Mise à jour');?></button>
						</div>
					</div>
                <?php echo form_close();?>
            </div>
