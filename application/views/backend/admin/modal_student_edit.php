		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/student/'.$row['class_id'].'/do_update/'.$row['student_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
							...
							<label for="field-2" class="col-sm-3 control-label"><?php echo ('Section');?></label>
			                    <div class="col-sm-5">
			                        <select name="section_id" class="form-control" id="section_selector_holder">
			                            <option value=""><?php echo ('Selectionner classe');?></option>
					...
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo ('Date Naissance');?></label>
					...
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo ('Statut');?></label>
                        
						<div class="col-sm-5">
							<select name="statut" class="form-control">
                              <option value=""><?php echo ('Selectionner');?></option>
                              <option value="Actif" <?php if($row['statut'] == 'Actif')echo 'selected';?>><?php echo ('Actif');?></option>
                              <option value="Inactif"<?php if($row['statut'] == 'Inactif')echo 'selected';?>><?php echo ('Inactif');?></option>
                          </select>
						</div> 
					</div>
                    ...
                    <div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<button type="submit" class="btn btn-info"><?php echo ('Editer');?></button>
						</div>
					</div>
                <?php echo form_close();?>
            </div>
