                ...
                <table class="table table-bordered datatable table-hover table-striped" id="table_export">
                    <thead>
                        <tr>
                            ...
                            <th width="80"><div><?php echo ('Numro Id');?></div></th>
                            <th><div><?php echo ('Nom');?></div></th>
                            <th><div><?php echo ('Sexe');?></div></th>
                            <th><div><?php echo ('Parent');?></div></th>
                            <th class="span3"><div><?php echo ('Addresse');?></div></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $this->crud_model->get_parent_name('parent',$row['student_id']);?></td>
