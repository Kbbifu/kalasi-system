...
<head>
    ...
    <link href="<?php echo base_url(); ?>assets/assets/css/colors/blue.css" id="theme" rel="stylesheet">
...
<body>
    ...
    <section id="wrapper" class="login-register login-sidebar" style="background-image:url(<?php echo base_url(); ?>assets/assets/images/background/hrbbg.jpg);">
        ...
        <div class="login-box card">
            <div class="card-body loginpage">
                ...
                <form class="form-horizontal form-material" method="post" id="loginform" action="login/Login_Auth">
                    <a href="javascript:void(0)" class="text-center db"><br/><img src="<?php echo base_url(); ?>assets/assets/images/hrinv.png" width="175px" alt="Home" /></a>
    ...
    <!--Menu sidebar -->
    <script src="<?php echo base_url(); ?>assets/assets/js/sidebarmenu.js"></script>
    <!--stickey kit -->
    ...
    <!--Custom JavaScript -->
    <script src="<?php echo base_url(); ?>assets/assets/js/custom.min.js"></script>
    <!-- ============================================================== -->
    <!-- Style switcher -->
    <!-- ============================================================== -->
